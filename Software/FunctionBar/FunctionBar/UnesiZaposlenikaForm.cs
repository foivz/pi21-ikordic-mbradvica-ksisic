...
namespace FunctionBar
{
    public partial class UnesiZaposlenikaForm : Form
    {
        ...
        private void UnesiZaposlenikaForm_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string helpPoveznica = "FunctionBarHelp.chm";
            Help.ShowHelp(this, Environment.CurrentDirectory + "\\Resources\\" + helpPoveznica, HelpNavigator.Topic, "start.htm#_Toc43663410");
        }
    }
}

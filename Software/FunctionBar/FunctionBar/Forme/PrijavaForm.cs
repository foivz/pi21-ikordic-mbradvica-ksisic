...
namespace FunctionBar.Forme
{
    public partial class PrijavaForm : Form
    {
        ...
        private void PrijavaForm_HelpRequested(object sender, HelpEventArgs hlpevent)
        {
            string helpPoveznica = "FunctionBarHelp.chm";
            Help.ShowHelp(this, Environment.CurrentDirectory + "\\Resources\\" + helpPoveznica, HelpNavigator.Topic, "start.htm#_Toc43663401");
        }
    }
}
